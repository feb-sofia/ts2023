...
Given a first order autoregressive process with $\psi = 0.8$, find the
...
$x_{t_0}$, $\psi$ and $e_t, e_{t + 1}, e_{t + 2}$, etc.
...
How does the process behave for different values of $\psi$? To answer this, focus on the
series:

$$
S_n = 1 + \psi + \psi^2 + \psi^3 + \ldots, \psi^n
$$

Show that

$$
S_n = \frac{1 - \psi^{n + 1}}{1 - \psi}
$$

What is the limit of this series depending on the value of $\psi$?
