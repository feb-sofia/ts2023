...
Compute the expectation of $Y$, given $X = 0$ using the distribution in @tbl-cond-distr-y-dep-x. For which value of $X$ is the condtitional expectation of $Y$ greatest?
